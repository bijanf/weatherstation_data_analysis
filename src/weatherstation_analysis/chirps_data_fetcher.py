...
class CHIRPSDataFetcher:
    ...
    def fetch_precipitation_data(
        ...
        """
        print(f"🛰️  Fetching CHIRPS data for {self.location_name} ({self.latitude}, {self.longitude})...")
        ...
        try:
            ...
            if data is None or 'data' not in data:
                print("⚠️ No valid data or 'data' key found in the response from ClimateSERV API.")
                return None
